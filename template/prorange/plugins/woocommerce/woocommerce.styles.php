...
if ( !function_exists( 'prorange_woocommerce_get_css' ) ) {
	add_filter( 'prorange_filter_get_css', 'prorange_woocommerce_get_css', 10, 4 );
	function prorange_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.prorange_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.prorange_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
