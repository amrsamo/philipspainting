...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (PRORANGE_STORAGE['button_hover'] && PRORANGE_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.prorange_tabs .prorange_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+PRORANGE_STORAGE['button_hover']);
		if (PRORANGE_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.scheme_dark .sc_button:not([class*="sc_button_simple"])\
				').addClass('sc_button_hover_just_init sc_button_hover_style_alter');
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.prorange_tabs .prorange_tabs_titles li a:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+PRORANGE_STORAGE['button_hover']);
