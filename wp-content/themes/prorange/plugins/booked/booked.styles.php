...
if (!function_exists('prorange_booked_get_css')) {
	add_filter('prorange_filter_get_css', 'prorange_booked_get_css', 10, 4);
	function prorange_booked_get_css($css, $colors, $fonts, $scheme='') {
