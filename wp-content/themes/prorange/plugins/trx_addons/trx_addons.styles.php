...
if (!function_exists('prorange_trx_addons_get_css')) {
	add_filter('prorange_filter_get_css', 'prorange_trx_addons_get_css', 10, 4);
	function prorange_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.footer_wrap.scheme_self .sc_layouts_row_type_normal .sc_layouts_item {
...
.sc_skills .counter-body .sc_skills_item_title{
    color:{$colors['bg_color_06']};
    }
.sc_skills .counter-body .sc_skills_total{
    color:{$colors['bg_color']};
    }
/* Action */
...
.sc_price .sc_price_info .sc_price_title a:hover {
	color: {$colors['extra_hover']};
}
